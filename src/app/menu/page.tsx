        ...
        <div className="md:px-12 lg:px-24">
            ...
            <div className="px-4 pb-1">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="grid grid-cols-3 gap-1 pt-3 xs:text-lg sx:text-xl md:text-2xl">
                        <div className="col-span-2">
                            <p className="px-2 pb-3">黒耀のとんかつ弁当　ロース</p>
                            <p className="pb-4 px-2">黒耀のとんかつ弁当　特上ロース</p>
                            <p className="pt-2 px-2 pb-3">黒耀のとんかつ弁当　ヒレ</p>
                            <p className="pb-4 px-2">黒耀のとんかつ弁当　特上ヒレ</p>
