        ...
        <div className="md:px-12 lg:px-24">
            <div className="px-2">
                <div className="px-2 pb-2 lg:pt-6">
                    <p className="text-lg xs:text-2xl lg:text-3xlfont-medium pl-2 pt-4 border-gray-300 border-b-2">おすすめメニュー</p>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-4">
                    <div className="flex justify-center pt-2">
                        <Image src="/korokke.jpg" alt="Image 1" width={300} height={300} className="rounded-md shadow" />
                    </div>
                    <div className="col-span-2 grid grid-cols-3 gap-1 pt-2 xs:text-lg md:text-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:pt-8">
                    <div className="col-span-1">
                    ...
                    <div className="grid grid-cols-3 gap-1 xs:text-lg md:text-2xl">
                        <div className="col-span-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-1 xs:text-lg md:text-2xl lg:pt-8">
                    <div className="col-span-1">
